...
import getCertificationRequestList from '@salesforce/apex/FetchData.certreqlist';
...
import TotalRecords from '@salesforce/apex/FetchData.TotalRecordsCR';
    ...
    deleteEmp(event){
        ...
        .then(() => {
            this.dispatchEvent(
                new ShowToastEvent({
                    title: 'Successfully deleted!',
                    message: did_str + ' Certification Request is deleted.',
                    variant: 'success',
                }),
            );
           // return refreshApex(this.refreshTable);
        ...
        .catch(error => {
            this.dispatchEvent(
                new ShowToastEvent({
                    title: 'Error while getting Certificate Requests', 
...
handleChange(event){
    ...
    .catch(error => {
        ...
        this.certificationrequests = null;
    });
    //return refreshApex(this.refreshTable);
}
addEmp(){
...
viewrec(event) {
        ...
        window.location.assign('https://rishav-jais-cma-dev-ed.lightning.force.com/lightning/r/Certification_Request__c/'+this.id_str+'/view');
    }
